...
app.post('/projects', checkAuth, (req, res) => {
...
app.delete('/projects/:id', checkAuth, (req, res, next) => {
...
app.post('/categories', checkAuth, (req, res) => {
  const { name } = req.body;
...
app.delete('/categories/:id', checkAuth, (req, res, next) => {
